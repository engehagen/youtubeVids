...
public class Gui extends JFrame {
	...
	private ButtonGroup group; // lager en gruppe av knapper som har gitte regler
	
	
	
	
	public Gui(){
		super("sykeste programmet");
		
		setLayout(new FlowLayout());
		
		tf = new JTextField("Sondre er sykt deilig og kul", 25);
		add (tf);
